...
use OpenCoreEMR\Modules\OncRegistration\Console\ModuleInstaller;
...
abstract class AbstractModuleCommand extends Command
{
    ...
    protected function getInstaller(): ModuleInstaller
    {
        ...
        if (!$this->installer instanceof \OpenCoreEMR\Modules\OncRegistration\Console\ModuleInstaller) {
